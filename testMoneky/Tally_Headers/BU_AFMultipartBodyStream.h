...
@class BU_AFHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;
...
@interface BU_AFMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    BU_AFHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) BU_AFHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
