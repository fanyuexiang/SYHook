...
@interface ABURewardedVideoAdLoader : ABUAdLoader <ABUCustomRewardedVideoAdapterBridge>
{
}

- (void)rewardedVideoAd:(id)arg1 didLoadFailWithError:(id)arg2 ext:(id)arg3;
- (void)rewardedVideoAd:(id)arg1 didLoadWithExt:(id)arg2;
