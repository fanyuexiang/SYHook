...
@interface UMSocialHandler : NSObject <UMSocialPlatformProvider>
{
    ...
    CDUnknownBlockType _launchFromPlatformCompletionBlock;
...
@property(copy, nonatomic) CDUnknownBlockType launchFromPlatformCompletionBlock; // @synthesize launchFromPlatformCompletionBlock=_launchFromPlatformCompletionBlock;
