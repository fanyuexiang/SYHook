...
#import "JDKeplerMultipartFormData-Protocol.h"

@class JDKeplerMultipartBodyStream, NSMutableURLRequest, NSString;

@interface JDKeplerStreamingMultipartFormData : NSObject <JDKeplerMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    JDKeplerMultipartBodyStream *_bodyStream;
}

- (void).cxx_destruct;
@property(retain, nonatomic) JDKeplerMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
