...
@class JXCategoryCollectionView, JXCategoryViewAnimator, NSArray, NSString, UIScrollView;
@protocol JXCategoryViewDelegate, JXCategoryViewListContainer;
...
{
    _Bool _contentScrollViewClickTransitionAnimationEnabled;
    ...
    _Bool _needReloadByBecomeActive;
    _Bool _firstLayoutSubviews;
    struct DelegateFlags _delegateFlags;
    JXCategoryCollectionView *_collectionView;
    NSArray *_dataSource;
    id <JXCategoryViewDelegate> _delegate;
    id <JXCategoryViewListContainer> _listContainer;
...
@property(nonatomic, getter=isNeedReloadByBecomeActive) _Bool needReloadByBecomeActive; // @synthesize needReloadByBecomeActive=_needReloadByBecomeActive;
@property(nonatomic) long long scrollingTargetIndex; // @synthesize scrollingTargetIndex=_scrollingTargetIndex;
...
@property(nonatomic) struct DelegateFlags delegateFlags; // @synthesize delegateFlags=_delegateFlags;
...
@property(nonatomic, getter=isCellWidthZoomScrollGradientEnabled) _Bool cellWidthZoomScrollGradientEnabled; // @synthesize cellWidthZoomScrollGradientEnabled=_cellWidthZoomScrollGradientEnabled;
...
@property(nonatomic, getter=isAverageCellSpacingEnabled) _Bool averageCellSpacingEnabled; // @synthesize averageCellSpacingEnabled=_averageCellSpacingEnabled;
...
@property(nonatomic, getter=isContentScrollViewClickTransitionAnimationEnabled) _Bool contentScrollViewClickTransitionAnimationEnabled; // @synthesize contentScrollViewClickTransitionAnimationEnabled=_contentScrollViewClickTransitionAnimationEnabled;
...
@property(nonatomic) __weak id <JXCategoryViewListContainer> listContainer; // @synthesize listContainer=_listContainer;
...
- (double)getCellWidthAtIndex:(long long)arg1;
...
- (void)initializeData;
- (struct CGRect)getTargetSelectedCellFrame:(long long)arg1 selectedType:(unsigned long long)arg2;
