...
@interface AssetSelectTableView : UITableView <UITableViewDelegate, UITableViewDataSource>
{
    _Bool _isFirstGroup;
...
- (void).cxx_destruct;
@property(nonatomic) _Bool isFirstGroup; // @synthesize isFirstGroup=_isFirstGroup;
