...
+ (id)objectWithPreviewImageURL:(id)arg1 title:(id)arg2 description:(id)arg3 tagName:(id)arg4 messageExt:(id)arg5;
...
- (id)initWithPreviewImageURL:(id)arg1 title:(id)arg2 description:(id)arg3 tagName:(id)arg4 messageExt:(id)arg5;
