...
@class MtopApiRequest, MtopBridgePlugin, NSDictionary, NSNumber, NSString, UIViewController;

@interface MtopApiRequestDelegateImpl : NSObject <MtopExtRequestDelegate>
{
    _Bool _isCallbacked;
...
- (id)initWithRequest:(id)arg1 requestId:(id)arg2 plugin:(id)arg3 callBack:(CDUnknownBlockType)arg4 timeout:(long long)arg5 parameters:(id)arg6 viewController:(id)arg7;
