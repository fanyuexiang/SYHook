...
@class BaiduMobAdAnimationBezierPath, BaiduMobAdAnimatorNode, BaiduMobAdNumberInterpolator, BaiduMobAdTransformInterpolator, CALayer;

@interface BaiduMobAdRenderGroup : BaiduMobAdAnimatorRenderNode
{
    BaiduMobAdAnimatorNode *_rootNode;
