...
@interface TBSDKRequest : NSObject <TBSDKConnectionDelegate, TBSDKProgressDelegate>
{
    ...
    NSMutableDictionary *_priorityData;
    NSMutableDictionary *_custhomHeaders;
    ...
    NSError *_rawError;
    NSDictionary *_securityFactors;
}

+ (long long)convertEnvironment2SGIndex:(long long)arg1;
+ (id)urlEncode:(id)arg1;
+ (id)dict2QueryString:(id)arg1;
+ (void)cancelTBSDKAllRequest;
+ (void)initialize;
@property(copy, nonatomic) NSDictionary *securityFactors; // @synthesize securityFactors=_securityFactors;
...
@property(retain, nonatomic) NSMutableDictionary *custhomHeaders; // @synthesize custhomHeaders=_custhomHeaders;
...
- (id)generateWUAWithRequest:(int)arg1 appkey:(id)arg2 timestamp:(id)arg3;
- (id)getMwua:(id)arg1;
- (_Bool)isNeedTradeUnitApi:(id)arg1;
- (id)getApiURL4Env;
- (id)getRequestURL;
- (void)reset;
