...
- (void)GDTfunctionz7m7aq:(double)arg1 completionHandler:(void (^)(_Bool))arg2;
- (void)GDTfunctionm5hue0:(double)arg1 completionHandler:(void (^)(_Bool))arg2;
- (UIImage *)GDTfunctiont50Vxg;
- (void)gdt_reset;
- (void)gdt_stop;
- (void)gdt_replay;
- (void)gdt_pause;
