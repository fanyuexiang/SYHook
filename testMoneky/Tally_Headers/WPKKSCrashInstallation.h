...
@class NSArray, NSMutableData, NSMutableDictionary, WPKKSCrashReportFilterPipeline;

@interface WPKKSCrashInstallation : NSObject
{
    int _nextFieldIndex;
    NSMutableData *_crashHandlerDataBacking;
    NSMutableDictionary *_fields;
    NSArray *_requiredProperties;
    WPKKSCrashReportFilterPipeline *_prependedFilters;
}

- (void).cxx_destruct;
@property(retain, nonatomic) WPKKSCrashReportFilterPipeline *prependedFilters; // @synthesize prependedFilters=_prependedFilters;
