...
@class BaiduMobAdMaskContainer, BaiduMobAdNumberInterpolator, BaiduMobAdRenderGroup, BaiduMobAdTransformInterpolator, NSDictionary, NSNumber, NSString;

@interface BaiduMobAdLayerContainer : CALayer
{
    ...
    BaiduMobAdRenderGroup *_contentsGroup;
    BaiduMobAdMaskContainer *_maskLayer;
    NSString *_layerName;
