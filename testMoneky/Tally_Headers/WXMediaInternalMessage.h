...
@interface WXMediaInternalMessage : NSObject
{
    ...
    _Bool _isAppBrandUpdatableMessage;
...
@property(retain, nonatomic) NSDictionary *gameLiveExtraInfoDic; // @synthesize gameLiveExtraInfoDic=_gameLiveExtraInfoDic;
@property(retain, nonatomic) NSDictionary *appBrandExtraInfoDic; // @synthesize appBrandExtraInfoDic=_appBrandExtraInfoDic;
@property(nonatomic) _Bool isSecretMessage; // @synthesize isSecretMessage=_isSecretMessage;
@property(nonatomic) _Bool isAppBrandUpdatableMessage; // @synthesize isAppBrandUpdatableMessage=_isAppBrandUpdatableMessage;
