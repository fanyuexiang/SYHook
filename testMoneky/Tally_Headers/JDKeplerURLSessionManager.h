...
@class JDKeplerNetworkReachabilityManager, JDKeplerSecurityPolicy, NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration;
@protocol JDKeplerURLResponseSerialization, OS_dispatch_group, OS_dispatch_queue;

@interface JDKeplerURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <JDKeplerURLResponseSerialization> _responseSerializer;
    JDKeplerSecurityPolicy *_securityPolicy;
    JDKeplerNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) JDKeplerNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) JDKeplerSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
@property(retain, nonatomic) id <JDKeplerURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
