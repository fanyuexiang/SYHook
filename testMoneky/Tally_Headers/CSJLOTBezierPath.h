...
@interface CSJLOTBezierPath : NSObject
{
    struct CSJLOT_Subpath *headSubpath_;
    struct CSJLOT_Subpath *tailSubpath_;
...
- (void)CSJLOT_enumeratePath:(struct CGPath *)arg1 elementsUsingBlock:(CDUnknownBlockType)arg2;
- (void)setWithCGPath:(struct CGPath *)arg1;
- (void)trimPathFromT:(double)arg1 toT:(double)arg2 offset:(double)arg3;
- (void)CSJLOT_appendPath:(id)arg1;
- (void)CSJLOT_applyTransform:(struct CGAffineTransform)arg1;
@property(readonly, nonatomic) struct CGRect bounds;
@property(readonly, getter=isEmpty) _Bool empty;
- (_Bool)containsPoint:(struct CGPoint)arg1;
- (void)CSJLOT_removeAllPoints;
- (void)_clearPathData;
- (void)CSJLOT_closePath;
- (void)CSJLOT_addCurveToPoint:(struct CGPoint)arg1 controlPoint1:(struct CGPoint)arg2 controlPoint2:(struct CGPoint)arg3;
- (void)CSJLOT_addLineToPoint:(struct CGPoint)arg1;
- (void)CSJLOT_moveToPoint:(struct CGPoint)arg1;
@property(readonly, nonatomic) struct CSJLOT_Subpath *headSubpath;
