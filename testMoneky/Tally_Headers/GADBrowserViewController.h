...
@class GADActionURLHandler, GADAdContent, GADEventContext, GADWebViewController, NSString, NSURL, UIActivityIndicatorView, UIBarButtonItem, UIToolbar, UIWindowScene;
