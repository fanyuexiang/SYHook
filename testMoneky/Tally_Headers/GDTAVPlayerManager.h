...
@class AVPlayer, AVPlayerItem, AVPlayerLayer, AVURLAsset, GDTKVOController, GDTPlayerView, GDTResourceLoaderManager, GDTVideoPlayerBusinessContext, NSString, NSURL;
...
@property(retain, nonatomic) GDTVideoPlayerBusinessContext *businessContext; // @synthesize businessContext=_businessContext;
...
- (_Bool)GDTfunctionw6hNKM;
- (CDStruct_198678f7)GDTfunctionw2u3eS;
...
- (void)GDTfunctionv8196I;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;
- (void)GDTfunctionr9akTq;
- (void)GDTfunctionr7h6YT;
- (void)GDTfunctionw5y6Ow:(_Bool)arg1 inPlayerItem:(id)arg2;
- (void)GDTfunctionm5gDYg;
- (double)GDTfunctionb1OriI;
- (void)GDTfunctionm5hue0:(double)arg1 tolerance:(CDStruct_198678f7)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)GDTfunctionz7m7aq:(double)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)GDTfunctionm5hue0:(double)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)GDTfunctiont50Vxg;
- (void)gdt_reset;
- (void)gdt_stop;
- (void)gdt_replay;
- (void)gdt_pause;
- (void)gdt_play;
- (void)GDTfunctionu9WjZg;
- (void)GDTfunctionh34Yw6;
- (void)dealloc;
- (id)init;
