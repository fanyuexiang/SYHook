...
@class JDKeplerURLSessionManager, NSMutableData, NSProgress, NSString, NSURL;

@interface JDKeplerURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
    JDKeplerURLSessionManager *_manager;
...
@property(nonatomic) __weak JDKeplerURLSessionManager *manager; // @synthesize manager=_manager;
