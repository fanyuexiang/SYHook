...
#import "CSJNormalVideoFinishViewProtocol-Protocol.h"

@class CSJAdSlot, CSJMaterialMeta, NSString, UIButton, UIImageView, UILabel;
...
@interface CSJNormalVideoFinishView : UIView <CSJNormalVideoFinishViewProtocol>
{
    ...
    CSJAdSlot *adSlot;
    CDUnknownBlockType replayClick;
    UIView *_maskView;
...
@property(copy, nonatomic) CDUnknownBlockType replayClick; // @synthesize replayClick;
