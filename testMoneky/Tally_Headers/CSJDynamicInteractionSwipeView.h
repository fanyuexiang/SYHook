...
#import "CSJDynamicInteractionSwipeAnimationDelegate-Protocol.h"
#import "UIGestureRecognizerDelegate-Protocol.h"

@class CSJDynamicInteractionContainerView, CSJDynamicInteractionSwipeAnimationView, NSString;

@interface CSJDynamicInteractionSwipeView : CSJSplashBottomBaseComponentView <UIGestureRecognizerDelegate, CSJDynamicInteractionSwipeAnimationDelegate>
{
    _Bool _swipeAnimationValid;
    CSJDynamicInteractionContainerView *_backgroundContainerView;
    CSJDynamicInteractionSwipeAnimationView *_swipeAnimationView;
    struct CGPoint _beginPoint;
    struct CGPoint _endPoint;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool swipeAnimationValid; // @synthesize swipeAnimationValid=_swipeAnimationValid;
...
@property(retain, nonatomic) CSJDynamicInteractionSwipeAnimationView *swipeAnimationView; // @synthesize swipeAnimationView=_swipeAnimationView;
...
- (void)swipeAnimationDidFinish:(id)arg1;
