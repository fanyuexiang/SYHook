...
@class NSMutableData, NSProgress, NSString, NSURL, WPKAFURLSessionManager;

@interface WPKAFURLSessionManagerTaskDelegate : NSObject <NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate>
{
...
@property(nonatomic) __weak WPKAFURLSessionManager *manager; // @synthesize manager=_manager;
