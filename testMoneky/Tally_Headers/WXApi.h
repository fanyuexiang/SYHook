...
+ (void)launchWechatWithExtralUrl:(id)arg1 forceScheme:(_Bool)arg2 contextId:(id)arg3 paramsDataStr:(id)arg4 unnecessaryDataErased:(_Bool)arg5 completion:(CDUnknownBlockType)arg6;
...
+ (_Bool)internalHandleOpenUrlWithAppData:(id)arg1 delegate:(id)arg2;
+ (void)handleRequestGrantReadPasteBoardWithURL:(id)arg1 appId:(id)arg2 delegate:(id)arg3;
...
+ (_Bool)handleChannelStartLiveOpenUrl:(id)arg1 delegate:(id)arg2;
...
+ (_Bool)handleLaunchWxaRedirectingPage:(id)arg1 delegate:(id)arg2;
...
+ (id)genChannelStartLiveExtraUrl:(id)arg1;
+ (id)genFinderOpenEventExtraUrl:(id)arg1;
+ (id)genOpenCustomerServiceExtraUrl:(id)arg1;
+ (id)genFinderOpenFeedExtraUrl:(id)arg1;
+ (id)genFinderOpenLiveExtraUrl:(id)arg1;
+ (id)genFinderOpenProfileExtraUrl:(id)arg1;
+ (id)genFinderShareVideoExtraUrl:(id)arg1;
...
+ (id)genLaunchWxaRedirectingPageReq:(id)arg1;
