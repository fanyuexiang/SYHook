...
- (void)requestDidFailWithRequest:(id)arg1 error:(id)arg2 fromRequest:(_Bool)arg3;
...
- (void)setSessionDidReceiveAuthenticationChanllengeBlock:(CDUnknownBlockType)arg1;
