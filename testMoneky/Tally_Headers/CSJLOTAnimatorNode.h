...
@class CSJLOTBezierPath, NSDictionary, NSNumber, NSString;

@interface CSJLOTAnimatorNode : NSObject
{
    _Bool _pathShouldCacheLengths;
    NSDictionary *_valueInterpolators;
    NSString *_keyname;
    NSNumber *_currentFrame;
    CSJLOTAnimatorNode *_inputNode;
    CSJLOTBezierPath *_localPath;
    CSJLOTBezierPath *_outputPath;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool pathShouldCacheLengths; // @synthesize pathShouldCacheLengths=_pathShouldCacheLengths;
@property(retain, nonatomic) CSJLOTBezierPath *outputPath; // @synthesize outputPath=_outputPath;
@property(retain, nonatomic) CSJLOTBezierPath *localPath; // @synthesize localPath=_localPath;
@property(readonly, nonatomic) CSJLOTAnimatorNode *inputNode; // @synthesize inputNode=_inputNode;
