...
@class BU_ASValueTrackingSlider, BU_MMMaterialDesignSpinner, NSBundle, NSDictionary, NSLayoutConstraint, NSString, UIButton, UIImageView, UILabel, UIProgressView;
...
@property(nonatomic) double playerAnimationTimeInterval; // @synthesize playerAnimationTimeInterval=_playerAnimationTimeInterval;
...
- (void)dealloc;
- (id)initWithContrlResourceBundle:(id)arg1 images:(id)arg2 localizedStrings:(id)arg3;
