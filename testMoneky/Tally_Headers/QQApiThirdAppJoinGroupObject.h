...
+ (id)objectWithAccessToken:(id)arg1 payToken:(id)arg2 pfkey:(id)arg3 unionID:(id)arg4;
...
- (id)initWithAccessToken:(id)arg1 payToken:(id)arg2 pfkey:(id)arg3 unionID:(id)arg4;
