...
@protocol GDTRewardAdPresenterProtocol <GDTClickFacadeDelegate>
@property(copy, nonatomic) CDUnknownBlockType logoClickCallback;
@property(copy, nonatomic) CDUnknownBlockType renderFailCallback;
@property(copy, nonatomic) CDUnknownBlockType renderSuccessCallback;
