...
#import "CSJLOTLayerContainer.h"

@class CALayer, CSJLOTNumberInterpolator, NSArray, NSDictionary, NSMutableDictionary, NSNumber;
...
@interface CSJLOTCompositionContainer : CSJLOTLayerContainer
{
    ...
    CSJLOTNumberInterpolator *_timeInterpolator;
