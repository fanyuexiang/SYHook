...
#import "APMESDKPropertyProviderDelegate-Protocol.h"

@class APMDatabase, APMEClient, APMEManager, APMPBMeasurementConfig, APMPEventEditing, GULMutableDictionary, NSArray, NSMutableArray, NSNumberFormatter, NSString, NSURL;
...
@property(readonly, nonatomic) _Bool persistentConfigInApplicationSupportEnabled;
...
- (id)remoteConfigURLWithAppInstanceID:(id)arg1 platform:(id)arg2 SDKVersion:(long long)arg3 runtimeVersion:(long long)arg4;
