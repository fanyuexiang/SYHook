...
#import "JDKeplerURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class JDKeplerHTTPRequestSerializer, JDKeplerHTTPResponseSerializer, NSURL;
@protocol JDKeplerURLRequestSerialization, JDKeplerURLResponseSerialization;

@interface JDKeplerHTTPSessionManager : JDKeplerURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    JDKeplerHTTPRequestSerializer<JDKeplerURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
+ (id)sharedKeplerSessionManager;
- (void).cxx_destruct;
@property(retain, nonatomic) JDKeplerHTTPRequestSerializer<JDKeplerURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
@property(retain, nonatomic) NSURL *baseURL; // @synthesize baseURL=_baseURL;
- (id)copyWithZone:(struct _NSZone *)arg1;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)description;
- (id)dataTaskWithHTTPMethod:(id)arg1 URLString:(id)arg2 parameters:(id)arg3 timeout:(double)arg4 uploadProgress:(CDUnknownBlockType)arg5 downloadProgress:(CDUnknownBlockType)arg6 success:(CDUnknownBlockType)arg7 failure:(CDUnknownBlockType)arg8;
...
- (id)POST:(id)arg1 parameters:(id)arg2 timeout:(double)arg3 progress:(CDUnknownBlockType)arg4 success:(CDUnknownBlockType)arg5 failure:(CDUnknownBlockType)arg6;
...
@property(retain, nonatomic) JDKeplerHTTPResponseSerializer<JDKeplerURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
