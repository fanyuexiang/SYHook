...
@protocol WVURLProtocolProcessor;
...
@interface WVURLProtocol : NSURLProtocol <NSURLConnectionDelegate, NSURLConnectionDataDelegate>
{
    ...
    id <WVURLProtocolProcessor> _processor;
}

+ (void)reportResource:(id)arg1 withResponse:(id)arg2 withExternalHeaders:(id)arg3 withFromType:(id)arg4;
+ (id)canonicalRequestForRequest:(id)arg1;
+ (_Bool)canInitWithRequest:(id)arg1;
+ (void)setup;
@property(retain, nonatomic) id <WVURLProtocolProcessor> processor; // @synthesize processor=_processor;
...
- (void)syncCookieForResponse:(id)arg1;
- (id)connection:(id)arg1 willSendRequest:(id)arg2 redirectResponse:(id)arg3;
- (void)protocolDidFailed:(id)arg1 withError:(id)arg2;
- (void)protocolDidFinish:(id)arg1;
- (void)protocolDidLoadData:(id)arg1;
- (void)protocolDidReceiveResponse:(id)arg1 withRequest:(id)arg2 fromType:(id)arg3;
- (void)stopLoading;
