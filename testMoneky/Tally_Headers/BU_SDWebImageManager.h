...
@protocol BU_SDImageLoader, BU_SDImageTransformer, BU_SDWebImageCacheKeyFilter, BU_SDWebImageCacheSerializer, BU_SDWebImageManagerDelegate, BU_SDWebImageOptionsProcessor, OS_dispatch_semaphore;

@interface BU_SDWebImageManager : NSObject
{
    id <BU_SDWebImageManagerDelegate> _delegate;
    BU_SDImageCache *_imageCache;
    id <BU_SDImageLoader> _imageLoader;
    id <BU_SDImageTransformer> _transformer;
    id <BU_SDWebImageCacheKeyFilter> _cacheKeyFilter;
    id <BU_SDWebImageCacheSerializer> _cacheSerializer;
    id <BU_SDWebImageOptionsProcessor> _optionsProcessor;
...
@property(retain, nonatomic) id <BU_SDWebImageOptionsProcessor> optionsProcessor; // @synthesize optionsProcessor=_optionsProcessor;
...
@property(retain, nonatomic) id <BU_SDImageTransformer> transformer; // @synthesize transformer=_transformer;
@property(retain, nonatomic) id <BU_SDImageLoader> imageLoader; // @synthesize imageLoader=_imageLoader;
@property(retain, nonatomic) BU_SDImageCache *imageCache; // @synthesize imageCache=_imageCache;
@property(nonatomic) __weak id <BU_SDWebImageManagerDelegate> delegate; // @synthesize delegate=_delegate;
