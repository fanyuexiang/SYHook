...
@interface BuySearchListTableView : UITableView <UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate>
{
...
- (void)addDataArray:(id)arg1;
- (id)initWithFrame:(struct CGRect)arg1 style:(long long)arg2 cellReuseIdentifier:(id)arg3;
- (void)dealloc;
