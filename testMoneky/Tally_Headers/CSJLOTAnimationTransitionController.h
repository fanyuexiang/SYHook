...
@class CSJLOTAnimationView, NSBundle, NSString;

@interface CSJLOTAnimationTransitionController : NSObject <UIViewControllerAnimatedTransitioning>
{
    CSJLOTAnimationView *transitionAnimationView_;
