...
#import "BaiduMobAdMRAIDStateDelegate-Protocol.h"
#import "BaiduMobAdWebExpandComposerDelegate-Protocol.h"

@class BaiduMobAdActionComposer, BaiduMobAdHTMLRenderer, BaiduMobAdVideoInterstitialRenderer, BaiduMobAdWebExpandComposer, NSString, UIViewController;
@protocol BaiduMobAdMRAIDState;
...
@property(copy, nonatomic) NSString *lastCreativeUrl; // @synthesize lastCreativeUrl=_lastCreativeUrl;
...
@property(nonatomic) __weak id <BaiduMobAdMRAIDState> state; // @synthesize state=_state;
...
@property(copy, nonatomic) NSString *mraidPlacementType; // @synthesize mraidPlacementType=_mraidPlacementType;
...
@property(copy, nonatomic) NSString *requestedResizeCustomClosePosition; // @synthesize requestedResizeCustomClosePosition=_requestedResizeCustomClosePosition;
...
@property(nonatomic) __weak BaiduMobAdHTMLRenderer *adRenderer; // @synthesize adRenderer=_adRenderer;
- (void)close;
...
- (void)onAdClickWithParameter:(id)arg1;
- (void)onAdClick;
- (void)onAdReady;
- (void)onAdSwitch;
- (void)onAdShow;
