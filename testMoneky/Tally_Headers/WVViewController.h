...
@class NSDictionary, NSString, NSURL, NSURLRequest, UIScrollView, UIView, WKWebViewConfiguration;
...
@interface WVViewController : UIViewController <WVViewControllerProtocol, WVWebViewDelegate>
{
    ...
    CDUnknownBlockType _webContentProcessDidTerminateAction;
}

@property(copy, nonatomic) CDUnknownBlockType webContentProcessDidTerminateAction; // @synthesize webContentProcessDidTerminateAction=_webContentProcessDidTerminateAction;
...
@property(nonatomic) _Bool allowsMixView; // @synthesize allowsMixView=_allowsMixView;
...
@property(readonly, nonatomic) _Bool usePreloadWebView; // @synthesize usePreloadWebView=_usePreloadWebView;
