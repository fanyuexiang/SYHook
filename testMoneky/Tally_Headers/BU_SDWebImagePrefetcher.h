...
@protocol BU_SDWebImagePrefetcherDelegate, OS_dispatch_queue;
...
@interface BU_SDWebImagePrefetcher : NSObject
{
    ...
    id <BU_SDWebImagePrefetcherDelegate> _delegate;
...
@property(nonatomic) __weak id <BU_SDWebImagePrefetcherDelegate> delegate; // @synthesize delegate=_delegate;
