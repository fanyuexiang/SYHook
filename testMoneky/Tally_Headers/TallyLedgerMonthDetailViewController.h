...
@class NSFetchedResultsController, NSString, SKSortSwitchView, UILabel, UITableView;

@interface TallyLedgerMonthDetailViewController : TallyLedgerViewController <NSFetchedResultsControllerDelegate, UITableViewDelegate, UITableViewDataSource>
{
    UITableView *_tableView;
    double _maxAmount;
    double _totalAmount;
    UILabel *_amountLabel;
    SKSortSwitchView *_sortView;
    NSString *_date;
