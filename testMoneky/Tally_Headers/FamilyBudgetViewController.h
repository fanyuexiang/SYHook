...
@interface FamilyBudgetViewController : FamilyViewController <UITableViewDelegate, UITableViewDataSource>
{
...
- (void)deleteMonthBudgetWithFinish:(CDUnknownBlockType)arg1;
