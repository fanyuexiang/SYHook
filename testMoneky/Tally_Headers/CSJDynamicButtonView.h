...
@class CSJDynamicButtonDecorator;

@interface CSJDynamicButtonView : CSJDynamicAbstractView
{
    CSJDynamicButtonDecorator *_buttonDecorator;
}

- (void).cxx_destruct;
@property(retain, nonatomic) CSJDynamicButtonDecorator *buttonDecorator; // @synthesize buttonDecorator=_buttonDecorator;
