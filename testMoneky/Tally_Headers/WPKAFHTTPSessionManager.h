...
#import "WPKAFURLSessionManager.h"

#import "NSCopying-Protocol.h"
#import "NSSecureCoding-Protocol.h"

@class NSURL, WPKAFHTTPRequestSerializer, WPKAFHTTPResponseSerializer, WPKAFSecurityPolicy;
@protocol WPKAFURLRequestSerialization, WPKAFURLResponseSerialization;

@interface WPKAFHTTPSessionManager : WPKAFURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
    WPKAFHTTPRequestSerializer<WPKAFURLRequestSerialization> *_requestSerializer;
}

+ (_Bool)supportsSecureCoding;
+ (id)manager;
- (void).cxx_destruct;
@property(retain, nonatomic) WPKAFHTTPRequestSerializer<WPKAFURLRequestSerialization> *requestSerializer; // @synthesize requestSerializer=_requestSerializer;
...
@property(retain, nonatomic) WPKAFSecurityPolicy *securityPolicy; // @dynamic securityPolicy;
@property(retain, nonatomic) WPKAFHTTPResponseSerializer<WPKAFURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
