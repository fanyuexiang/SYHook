...
@class CSJLOTKeyframe, NSArray;

@interface CSJLOTValueInterpolator : NSObject
{
    _Bool _hasDelegateOverride;
    CSJLOTKeyframe *_leadingKeyframe;
    CSJLOTKeyframe *_trailingKeyframe;
    NSArray *_keyframes;
}
...
@property(nonatomic) __weak CSJLOTKeyframe *trailingKeyframe; // @synthesize trailingKeyframe=_trailingKeyframe;
@property(nonatomic) __weak CSJLOTKeyframe *leadingKeyframe; // @synthesize leadingKeyframe=_leadingKeyframe;
