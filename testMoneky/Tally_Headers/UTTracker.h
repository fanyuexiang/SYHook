...
@class NSMutableDictionary, NSString, UTDSDKInfo;
...
@property(readonly, copy) UTDSDKInfo *mSdkinfo; // @synthesize mSdkinfo;
- (void).cxx_destruct;
...
- (id)getAppKey;
- (id)initWithTracker:(id)arg1 trackid:(id)arg2;
- (id)initWithAppKey:(id)arg1 appsecret:(id)arg2 authcode:(id)arg3 securitySign:(_Bool)arg4;
