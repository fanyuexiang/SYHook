...
@class BaiduMobAdKeyframeGroup;

@interface BaiduMobAdMask : NSObject
{
    _Bool _closed;
    _Bool _inverted;
    unsigned long long _maskMode;
    BaiduMobAdKeyframeGroup *_maskPath;
    BaiduMobAdKeyframeGroup *_opacity;
    BaiduMobAdKeyframeGroup *_expansion;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) BaiduMobAdKeyframeGroup *expansion; // @synthesize expansion=_expansion;
@property(readonly, nonatomic) BaiduMobAdKeyframeGroup *opacity; // @synthesize opacity=_opacity;
@property(readonly, nonatomic) BaiduMobAdKeyframeGroup *maskPath; // @synthesize maskPath=_maskPath;
