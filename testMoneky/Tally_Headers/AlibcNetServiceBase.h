...
- (_Bool)performJSSend:(id)arg1;
- (_Bool)performSend:(id)arg1;
- (_Bool)inerProcessPacket:(id)arg1 bWaiting:(_Bool)arg2;
- (_Bool)inerProcessJSPacket:(id)arg1 bWaiting:(_Bool)arg2;
- (_Bool)processJSPacket:(id)arg1;
- (_Bool)processPacket:(id)arg1;
- (void)netPacketFail:(id)arg1 error:(id)arg2;
- (void)netPacketSuccess:(id)arg1 data:(id)arg2;
- (void)netJSPacketSuccess:(id)arg1 data:(id)arg2;
- (void)netJSPacketFail:(id)arg1 error:(id)arg2;
