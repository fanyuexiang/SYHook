...
@property(copy) NSDictionary *customHeader; // @synthesize customHeader=_customHeader;
...
- (void)removeCustomHeaderKey:(id)arg1;
...
@property(copy, nonatomic) NSString *abVersionID;
@property(copy, nonatomic) NSString *userUniqueID;
