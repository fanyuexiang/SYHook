...
@interface TBSDKAccountInfo : NSObject
{
    ...
    _Bool _isSidInvalid;
    NSString *_openToken;
    id <IAccountSource> _source;
}

+ (_Bool)isLoggedIn;
+ (id)shareInstance;
@property(nonatomic) __weak id <IAccountSource> source; // @synthesize source=_source;
@property(retain) NSString *openToken; // @synthesize openToken=_openToken;
