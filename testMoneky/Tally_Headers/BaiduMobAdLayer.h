...
@class BaiduMobAdAsset, BaiduMobAdKeyframeGroup, NSArray, NSNumber, NSString, UIColor;

@interface BaiduMobAdLayer : NSObject
{
    NSString *_layerName;
    ...
    UIColor *_solidColor;
    BaiduMobAdAsset *_imageAsset;
    BaiduMobAdKeyframeGroup *_opacity;
    BaiduMobAdKeyframeGroup *_timeRemapping;
    BaiduMobAdKeyframeGroup *_rotation;
    BaiduMobAdKeyframeGroup *_position;
    BaiduMobAdKeyframeGroup *_positionX;
    BaiduMobAdKeyframeGroup *_positionY;
...
@property(readonly, nonatomic) BaiduMobAdKeyframeGroup *positionY; // @synthesize positionY=_positionY;
@property(readonly, nonatomic) BaiduMobAdKeyframeGroup *positionX; // @synthesize positionX=_positionX;
...
@property(readonly, nonatomic) BaiduMobAdKeyframeGroup *timeRemapping; // @synthesize timeRemapping=_timeRemapping;
@property(readonly, nonatomic) BaiduMobAdKeyframeGroup *opacity; // @synthesize opacity=_opacity;
@property(readonly, nonatomic) BaiduMobAdAsset *imageAsset; // @synthesize imageAsset=_imageAsset;
