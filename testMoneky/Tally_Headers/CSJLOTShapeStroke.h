...
@class CSJLOTKeyframeGroup, NSArray, NSString;
...
@interface CSJLOTShapeStroke : NSObject
{
    ...
    CSJLOTKeyframeGroup *_width;
    CSJLOTKeyframeGroup *_dashOffset;
...
@property(readonly, nonatomic) CSJLOTKeyframeGroup *dashOffset; // @synthesize dashOffset=_dashOffset;
@property(readonly, nonatomic) CSJLOTKeyframeGroup *width; // @synthesize width=_width;
