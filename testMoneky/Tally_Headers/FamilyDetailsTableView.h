...
@class FamilyDetailsController, NSString;

@interface FamilyDetailsTableView : UITableView <UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate>
{
    NSString *_date;
...
- (_Bool)isSameDateWithYYYYMM:(id)arg1;
