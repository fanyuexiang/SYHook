...
@class NSDate, NSFetchRequest, NSMutableArray, NSNumberFormatter, NSString, TallyLedgerPopView, UIPanGestureRecognizer, UIScrollView;

@interface TallyLedgerChartView : UIView
{
