...
@interface EBAppLogSessionHandler : NSObject
{
    ...
    _Bool _shouldMarkLaunchedPassively;
...
+ (id)sharedHandler;
- (void).cxx_destruct;
@property(nonatomic) _Bool shouldMarkLaunchedPassively; // @synthesize shouldMarkLaunchedPassively=_shouldMarkLaunchedPassively;
