...
@class CSJLOTBezierData, NSArray, NSNumber, UIColor;

@interface CSJLOTKeyframe : NSObject
{
    _Bool _isHold;
    NSNumber *_keyframeTime;
    double _floatValue;
    UIColor *_colorValue;
    CSJLOTBezierData *_pathData;
    NSArray *_arrayValue;
...
@property(readonly, nonatomic) CSJLOTBezierData *pathData; // @synthesize pathData=_pathData;
...
- (id)initWithCSJLOTKeyframe:(id)arg1;
