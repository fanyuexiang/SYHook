...
#import "BU_SDAnimatedImageProvider-Protocol.h"

@class NSData, NSDictionary;
@protocol BU_SDAnimatedImageCoder;

@protocol BU_SDAnimatedImage <BU_SDAnimatedImageProvider>
- (id)initWithAnimatedCoder:(id <BU_SDAnimatedImageCoder>)arg1 scale:(double)arg2;
