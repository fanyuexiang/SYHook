...
@class GDTVideoPlayerBusinessContext, NSMutableArray, NSString, NSURL;
...
- (void).cxx_destruct;
- (void)GDTfunctiont7O6Cc:(id)arg1;
- (void)GDTfunctiont9uvut:(id)arg1 didCompleteWithError:(id)arg2;
- (void)cancel;
