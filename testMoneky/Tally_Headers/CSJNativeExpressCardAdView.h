...
@interface CSJNativeExpressCardAdView : CSJNativeExpressAdView <UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, CSJNativeExpressAdViewDelegate, CSJNativeExpressAdConverterDelegate, CSJNativeExpressAdViewDismissDelegate, CSJNativeAdsManagerDelegate>
{
    ...
    CSJNativeExpressAdManager *_IOS_StopStmt;
    UICollectionView *_Logo_Not_rhs;
    NSMutableArray *_Lds_BOOLView;
    CSJAdSlot *_adSlot;
    CSJNativeAdsManager *_YES_Mark_rhs;
    CSJNativeExpressAdConverter *_nativeExpressAdConverter;
    UILabel *_tipsView;
    CSJViewTracker *__cmd_MAXIt;
    double _showTime;
    NSMutableSet *_An_MINOnly;
    NSMutableArray *_Os_StmtBy;
    struct CGSize _cardSize;
    struct CGPoint _lastContentOffset;
}

- (void).cxx_destruct;
@property(nonatomic) _Bool The_URLIf; // @synthesize The_URLIf=_The_URLIf;
@property(nonatomic) _Bool Ftc_SetMeta; // @synthesize Ftc_SetMeta=_Ftc_SetMeta;
@property(retain, nonatomic) NSMutableArray *Os_StmtBy; // @synthesize Os_StmtBy=_Os_StmtBy;
@property(nonatomic) _Bool Save_MetaIv; // @synthesize Save_MetaIv=_Save_MetaIv;
@property(retain, nonatomic) NSMutableSet *An_MINOnly; // @synthesize An_MINOnly=_An_MINOnly;
@property(nonatomic) double showTime; // @synthesize showTime=_showTime;
@property(retain, nonatomic) CSJViewTracker *_cmd_MAXIt; // @synthesize _cmd_MAXIt=__cmd_MAXIt;
...
@property(retain, nonatomic) CSJNativeAdsManager *YES_Mark_rhs; // @synthesize YES_Mark_rhs=_YES_Mark_rhs;
@property(retain, nonatomic) CSJAdSlot *adSlot; // @synthesize adSlot=_adSlot;
@property(retain, nonatomic) NSMutableArray *Lds_BOOLView; // @synthesize Lds_BOOLView=_Lds_BOOLView;
@property(retain, nonatomic) UICollectionView *Logo_Not_rhs; // @synthesize Logo_Not_rhs=_Logo_Not_rhs;
@property(nonatomic) __weak CSJNativeExpressAdManager *IOS_StopStmt; // @synthesize IOS_StopStmt=_IOS_StopStmt;
...
- (id)nativeAd;
- (long long)Show_DicWith;
- (id)Obj_AppFor:(long long)arg1;
- (id)Map_ListRect:(long long)arg1;
- (void)Wiki_SDKDuan;
- (void)viewShow;
