...
@protocol ALBBMBProgressHUDDelegate;

@interface ALBBMBProgressHUD : UIView
{
    _Bool useAnimation;
    ...
    float progress;
    float _cornerRadius;
    id <ALBBMBProgressHUDDelegate> delegate;
    UIColor *color;
    UIFont *labelFont;
    UIColor *labelColor;
...
@property __weak id <ALBBMBProgressHUDDelegate> delegate; // @synthesize delegate;
