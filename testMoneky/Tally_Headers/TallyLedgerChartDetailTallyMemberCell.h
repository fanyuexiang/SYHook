...
@class CBAttributedLabel, SKThemeSettingItem, TallyLedgerChartTallyCategoryMemberModel, UIImageView, UILabel, UIView;

@interface TallyLedgerChartDetailTallyMemberCell : UITableViewCell
{
    CBAttributedLabel *_remarkLabel;
    UILabel *_percentLabel;
    UILabel *_amountLabel;
    UILabel *_progressView;
    TallyLedgerChartTallyCategoryMemberModel *_model;
...
- (void)clearData;
- (double)calculateLabelWidth:(id)arg1;
