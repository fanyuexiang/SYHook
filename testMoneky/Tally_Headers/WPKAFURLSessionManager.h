...
@class NSArray, NSLock, NSMutableDictionary, NSOperationQueue, NSString, NSURLSession, NSURLSessionConfiguration, WPKAFNetworkReachabilityManager, WPKAFSecurityPolicy;
@protocol OS_dispatch_group, OS_dispatch_queue, WPKAFURLResponseSerialization;

@interface WPKAFURLSessionManager : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDownloadDelegate, NSSecureCoding, NSCopying>
{
    _Bool _attemptsToRecreateUploadTasksForBackgroundSessions;
    NSURLSession *_session;
    NSOperationQueue *_operationQueue;
    id <WPKAFURLResponseSerialization> _responseSerializer;
    WPKAFSecurityPolicy *_securityPolicy;
    WPKAFNetworkReachabilityManager *_reachabilityManager;
...
@property(retain, nonatomic) WPKAFNetworkReachabilityManager *reachabilityManager; // @synthesize reachabilityManager=_reachabilityManager;
@property(retain, nonatomic) WPKAFSecurityPolicy *securityPolicy; // @synthesize securityPolicy=_securityPolicy;
@property(retain, nonatomic) id <WPKAFURLResponseSerialization> responseSerializer; // @synthesize responseSerializer=_responseSerializer;
