...
@class CBAttributedLabel, SKThemeSettingItem, TallyLabelChartModel, UIImageView, UILabel, UIView;

@interface TallyLedgerChartLabelDetailCell : UITableViewCell
{
    CBAttributedLabel *_remarkLabel;
    UILabel *_percentLabel;
    UILabel *_amountLabel;
    UILabel *_progressView;
    TallyLabelChartModel *_model;
