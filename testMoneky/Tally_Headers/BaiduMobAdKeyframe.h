...
@class BaiduMobAdBezierData, NSArray, NSNumber, UIColor;

@interface BaiduMobAdKeyframe : NSObject
{
    _Bool _isHold;
    NSNumber *_keyframeTime;
    double _floatValue;
    UIColor *_colorValue;
    BaiduMobAdBezierData *_pathData;
    NSArray *_arrayValue;
...
@property(readonly, nonatomic) BaiduMobAdBezierData *pathData; // @synthesize pathData=_pathData;
