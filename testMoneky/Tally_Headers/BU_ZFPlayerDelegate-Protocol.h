...
@optional
- (void)zf_playerView:(BU_ZFPlayerView *)arg1 videoDidReachProgressTime:(double)arg2 duration:(double)arg3;
- (void)zf_playerBoundaryTimeReached:(BU_ZFPlayerView *)arg1;
...
- (void)zf_playerViewReadyToPlayWhenApplicationEnterBackground:(BU_ZFPlayerView *)arg1;
