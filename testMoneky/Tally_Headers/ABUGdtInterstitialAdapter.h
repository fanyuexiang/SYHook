...
@property(retain, nonatomic) NSObject<ABUGDT_GDTExpressInterstitialAd> *expressIfiedInterstitialAd; // @synthesize expressIfiedInterstitialAd=_expressIfiedInterstitialAd;
@property(retain, nonatomic) NSObject<ABUGDT_GDTUnifiedInterstitialAd> *interstitialAd; // @synthesize interstitialAd=_interstitialAd;
