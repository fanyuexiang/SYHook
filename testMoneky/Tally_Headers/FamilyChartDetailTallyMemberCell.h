...
@class CBAttributedLabel, FamilyChartTallyMemberModel, SKThemeSettingItem, UIImageView, UILabel, UIView;

@interface FamilyChartDetailTallyMemberCell : UITableViewCell
{
    CBAttributedLabel *_remarkLabel;
    UILabel *_percentLabel;
    UILabel *_amountLabel;
    UILabel *_progressView;
    FamilyChartTallyMemberModel *_model;
