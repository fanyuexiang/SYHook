...
#import "BU_SDImageCache-Protocol.h"
...
- (void)serialQueryImageForKey:(id)arg1 options:(unsigned long long)arg2 context:(id)arg3 completion:(CDUnknownBlockType)arg4 enumerator:(id)arg5 operation:(id)arg6;
...
- (void)concurrentQueryImageForKey:(id)arg1 options:(unsigned long long)arg2 context:(id)arg3 completion:(CDUnknownBlockType)arg4 enumerator:(id)arg5 operation:(id)arg6;
