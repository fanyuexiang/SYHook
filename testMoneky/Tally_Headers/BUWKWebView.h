...
@property(nonatomic) _Bool reallySuccess; // @synthesize reallySuccess=_reallySuccess;
...
- (double)checkWebContentBlankPercent:(id)arg1;
- (void)bu_oldDetectBlankWebViewPercentCompleteBlock:(CDUnknownBlockType)arg1;
- (void)bu_detectBlankPercentCompleteBlock:(CDUnknownBlockType)arg1;
- (void)bu_detectBlankPercentWithImageStr:(id)arg1 completeBlock:(CDUnknownBlockType)arg2;
...
- (void)ttr_fireEvent:(id)arg1 data:(id)arg2 completion:(CDUnknownBlockType)arg3;
