...
@class BU_SVGKImage, NSDate;

@interface BU_SVGKLayer : CALayer
{
    _Bool _showBorder;
    BU_SVGKImage *_SVGImage;
...
@property(retain, nonatomic) BU_SVGKImage *SVGImage; // @synthesize SVGImage=_SVGImage;
- (void)dealloc;
- (id)init;
