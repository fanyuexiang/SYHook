...
+ (_Bool)setAppCommunicateData:(id)arg1 forAppID:(id)arg2 canReadPasteBoard:(_Bool)arg3;
+ (_Bool)setPropertyList:(id)arg1 forAppID:(id)arg2 canReadPasteBoard:(_Bool)arg3;
