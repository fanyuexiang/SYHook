...
@class CSJLOTMaskContainer, CSJLOTNumberInterpolator, CSJLOTRenderGroup, CSJLOTTransformInterpolator, NSDictionary, NSNumber, NSString;
...
@interface CSJLOTLayerContainer : CALayer
{
    ...
    CSJLOTRenderGroup *_contentsGroup;
    CSJLOTMaskContainer *_maskLayer;
    NSString *_layerName;
