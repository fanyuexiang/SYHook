...
@class DetailTopView, NSExpressionDescription, NSFetchRequest, NSFetchedResultsController, NSMutableArray, NSString, TallyDetailRefreshFooterView, TallyDetailRefreshHeaderView, UIImageView, UIViewController;
@protocol UIScrollViewDelegate;

@interface TallyLedgerDetailTableView : UITableView <UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate, UIScrollViewDelegate>
{
    ...
    TallyDetailRefreshHeaderView *_headerRefreshView;
...
@property(retain, nonatomic) TallyDetailRefreshFooterView *footerRefreshView; // @synthesize footerRefreshView=_footerRefreshView;
@property(retain, nonatomic) TallyDetailRefreshHeaderView *headerRefreshView; // @synthesize headerRefreshView=_headerRefreshView;
...
- (void)closeRefreshFooterView;
- (void)closeRefreshHeaderView;
- (void)firstReloadData;
- (void)setup;
- (id)initWithFrame:(struct CGRect)arg1 style:(long long)arg2 topView:(id)arg3 dataSectionType:(long long)arg4 bookid:(long long)arg5;
- (void)dealloc;
