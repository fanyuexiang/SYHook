...
@interface CSJLOTMask : NSObject
{
    ...
    CSJLOTKeyframeGroup *_maskPath;
    CSJLOTKeyframeGroup *_opacity;
    CSJLOTKeyframeGroup *_expansion;
}

- (void).cxx_destruct;
@property(readonly, nonatomic) CSJLOTKeyframeGroup *expansion; // @synthesize expansion=_expansion;
@property(readonly, nonatomic) CSJLOTKeyframeGroup *opacity; // @synthesize opacity=_opacity;
@property(readonly, nonatomic) CSJLOTKeyframeGroup *maskPath; // @synthesize maskPath=_maskPath;
