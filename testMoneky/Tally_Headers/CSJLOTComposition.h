...
@class CSJLOTAssetGroup, CSJLOTLayerGroup, NSBundle, NSNumber, NSString;
...
@interface CSJLOTComposition : NSObject
{
    ...
    CSJLOTLayerGroup *_layerGroup;
    CSJLOTAssetGroup *_assetGroup;
...
+ (id)_downloaderHanderWithURL:(id)arg1 data:(id)arg2 error:(id)arg3;
...
@property(readonly, nonatomic) CSJLOTAssetGroup *assetGroup; // @synthesize assetGroup=_assetGroup;
@property(readonly, nonatomic) CSJLOTLayerGroup *layerGroup; // @synthesize layerGroup=_layerGroup;
