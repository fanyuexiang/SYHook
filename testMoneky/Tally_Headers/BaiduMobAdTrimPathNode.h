...
@class BaiduMobAdNumberInterpolator;

@interface BaiduMobAdTrimPathNode : BaiduMobAdAnimatorNode
{
    BaiduMobAdNumberInterpolator *_startInterpolator;
    BaiduMobAdNumberInterpolator *_endInterpolator;
