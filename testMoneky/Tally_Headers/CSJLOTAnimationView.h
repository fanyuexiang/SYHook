...
@class CSJLOTComposition, CSJLOTCompositionContainer, NSBundle, NSNumber, NSString;

@interface CSJLOTAnimationView : UIView <CAAnimationDelegate>
{
    CSJLOTCompositionContainer *_compContainer;
...
@property(retain, nonatomic) CSJLOTComposition *sceneModel; // @synthesize sceneModel=_sceneModel;
