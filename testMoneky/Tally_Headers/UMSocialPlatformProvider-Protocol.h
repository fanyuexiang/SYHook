...
- (_Bool)umSocial_handleUniversalLink:(id)arg1 options:(NSDictionary *)arg2;
...
- (void)umSocial_setLauchFromPlatform:(long long)arg1 withCompletionHandler:(void (^)(id, NSError *))arg2;
