...
@interface SettingTallyItemsPickerView : UIView <UITableViewDelegate, UITableViewDataSource>
{
...
- (id)initWithFrame:(struct CGRect)arg1 selectedIndex:(id)arg2 items:(id)arg3;
- (void)dealloc;
