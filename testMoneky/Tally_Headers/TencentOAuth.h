...
+ (_Bool)isUserAgreedAuthorization;
+ (void)setIsUserAgreedAuthorization:(_Bool)arg1;
@property(copy, nonatomic) NSString *oAuthState; // @synthesize oAuthState=_oAuthState;
@property(copy, nonatomic) NSString *proxyAppid; // @synthesize proxyAppid=_proxyAppid;
@property(nonatomic) int webAuthType; // @synthesize webAuthType=_webAuthType;
...
- (_Bool)proxyAuthorize:(id)arg1 permissions:(id)arg2 state:(id)arg3;
- (_Bool)proxyAuthorize:(id)arg1 permissions:(id)arg2;
- (_Bool)authorizeWithQRlogin:(id)arg1;
- (_Bool)authorize:(id)arg1 localAppId:(id)arg2;
...
- (id)initWithAppId:(id)arg1 andUniversalLink:(id)arg2 andDelegate:(id)arg3;
- (id)initWithAppId:(id)arg1 enableUniveralLink:(_Bool)arg2 universalLink:(id)arg3 delegate:(id)arg4;
- (void)deleteAPIRequestBySeq:(id)arg1;
- (void)cancelWithRequestKey:(id)arg1;
- (void)setProxyAuthResp:(id)arg1;
- (id)proxyAuthResp;
