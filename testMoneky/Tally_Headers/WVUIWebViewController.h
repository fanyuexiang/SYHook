...
@class NSArray, NSString, NSURL, NSURLRequest, UIColor, UIScrollView, UIView, WVNavigationBarBackgroundStatus, WVUIButtonItem, WVUIErrorView, WVUILoadingBox, WVWebViewToolbar;
