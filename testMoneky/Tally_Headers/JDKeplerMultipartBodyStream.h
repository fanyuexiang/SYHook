...
@class JDKeplerHTTPBodyPart, NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString;
@protocol NSStreamDelegate;

@interface JDKeplerMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    JDKeplerHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) JDKeplerHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
