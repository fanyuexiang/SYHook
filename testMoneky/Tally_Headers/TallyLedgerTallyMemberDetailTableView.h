...
@interface TallyLedgerTallyMemberDetailTableView : UITableView <UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate>
{
...
- (void)fetchTallyDate:(id)arg1 user:(id)arg2 tallyType:(long long)arg3 sortType:(long long)arg4;
- (void)setup;
