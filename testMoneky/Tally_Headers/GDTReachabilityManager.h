...
@interface GDTReachabilityManager : NSObject
{
...
- (void).cxx_destruct;
- (void)setGDTfunctionb1cjpS:(CDUnknownBlockType)arg1;
- (id)GDTfunctionb9CKwL;
- (void)stopMonitoring;
...
- (void)dealloc;
- (id)init;
- (id)initLr7doz1:(struct __SCNetworkReachability *)arg1;
