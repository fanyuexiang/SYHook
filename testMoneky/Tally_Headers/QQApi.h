...
+ (id)getTIMInstallURL;
+ (id)getQQInstallURL;
+ (_Bool)isQQSupportApiForProxyLogin;
...
+ (_Bool)isQQSupportApiForGroupPro;
+ (_Bool)isQQSupportApiForCheckAuth;
+ (_Bool)isQQSupportApiForLaunchMiniApp;
+ (_Bool)isQQSupportApiForMiniApp;
+ (_Bool)isQQSupportApiForAvatarSetting;
+ (_Bool)isQQSupportApiForThirdAppGroup;
...
+ (long long)checkMessageContentLegal:(id)arg1;
+ (_Bool)checkQQSupportMessage:(id)arg1;
+ (long long)checkLegalForMessage:(id)arg1;
+ (_Bool)isQQApiObjectLegal:(id)arg1;
+ (long long)sendMessage:(id)arg1;
+ (void)showErrorWithWebView:(id)arg1;
+ (_Bool)checkQQApiURLMessage:(id)arg1;
+ (_Bool)checkQQGroupProMessage:(id)arg1;
