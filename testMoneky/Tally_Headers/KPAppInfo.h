...
@interface KPAppInfo : KPModel
{
    ...
    long long _visitTimes;
    long long _firstVisitTimeStamp;
    long long _lastVisitTimeStamp;
    long long _currentVisitTimeStamp;
}
...
+ (id)sharedAppInfo;
- (void).cxx_destruct;
@property(nonatomic) long long currentVisitTimeStamp; // @synthesize currentVisitTimeStamp=_currentVisitTimeStamp;
@property(nonatomic) long long lastVisitTimeStamp; // @synthesize lastVisitTimeStamp=_lastVisitTimeStamp;
@property(nonatomic) long long firstVisitTimeStamp; // @synthesize firstVisitTimeStamp=_firstVisitTimeStamp;
@property(nonatomic) long long visitTimes; // @synthesize visitTimes=_visitTimes;
