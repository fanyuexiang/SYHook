...
@property(nonatomic) __weak id <TBSDKProgressDelegate> downloadProgressDelegate; // @synthesize downloadProgressDelegate=_downloadProgressDelegate;
@property(nonatomic) __weak id <TBSDKCacheDelegate> downloadCache; // @synthesize downloadCache=_downloadCache;
@property(nonatomic) int cachePolicy; // @synthesize cachePolicy=_cachePolicy;
@property(retain, nonatomic) NSURL *url; // @synthesize url=_url;
@property(nonatomic) __weak id <TBSDKProgressDelegate> uploadProgressDelegate; // @synthesize uploadProgressDelegate=_uploadProgressDelegate;
- (void).cxx_destruct;
- (void)dealloc;
- (void)utLog;
...
- (void)addCustomRequestHeader:(id)arg1 value:(id)arg2;
