...
@class BaiduMobAdComposition, BaiduMobAdCompositionContainer, NSBundle, NSDictionary, NSNumber, NSString;

@interface BaiduMobAdAnimationView : UIView <CAAnimationDelegate>
{
    BaiduMobAdCompositionContainer *_compContainer;
    NSNumber *_playRangeStartFrame;
    NSNumber *_playRangeEndFrame;
    double _playRangeStartProgress;
    double _playRangeEndProgress;
    NSBundle *_bundle;
    NSDictionary *_imagesArray;
    ...
    BaiduMobAdComposition *_sceneModel;
}

+ (id)animationWithJson:(id)arg1 withImage:(id)arg2;
...
@property(retain, nonatomic) BaiduMobAdComposition *sceneModel; // @synthesize sceneModel=_sceneModel;
...
- (id)initWithModel:(id)arg1 inBundle:(id)arg2 withImage:(id)arg3;
