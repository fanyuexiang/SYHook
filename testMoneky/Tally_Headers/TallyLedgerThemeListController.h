...
@class NSString, TallyLedgerThemeListDataSource, UICollectionView;

@interface TallyLedgerThemeListController : TallyLedgerViewController <UICollectionViewDelegate, UICollectionViewDataSource>
{
    TallyLedgerThemeListDataSource *_dataSource;
...
@property(retain, nonatomic) TallyLedgerThemeListDataSource *dataSource; // @synthesize dataSource=_dataSource;
